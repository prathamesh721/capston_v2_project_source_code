            ...
            <div className='aem-Grid aem-Grid--12 container'>
                <div className='aem-GridColumn aem-GridColumn--default--8 aem-GridColumn--phone--12 aem-GridColumn--tablet--12'>
                    <div className='aem-Grid aem-Grid--12'>
                        <h3 className='orderNumber paddingLeft1em'>Order Number #1700834</h3>
                        <div className='aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--phone--12 aem-GridColumn--tablet--12'>
                            ...
                            <p>{email}</p>
                            <p>{phone}</p>
                            <p>{firsName} {lastName} {address1}, {city} {zip} {state}</p>
                        </div>
                        <div className='aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--phone--12 aem-GridColumn--tablet--12'>
                            ...
                            <div>
                                ...
                                <p>{localPaymentInfo.paymentOption} {localPaymentInfo.paymentOption === 'Credit Card' ? 'Visa ending in 4567' : ''} </p>
                            </div>
                        </div>

                    </div>
                    <div className='aem-Grid aem-Grid--12'>
                        <p className='infoHeading paddingLeft1em'>{cartTotalQuantity} items in your order</p>
